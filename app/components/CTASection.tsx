    ...
    <section className="bg-[#F5E6D3] py-32">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#142929] rounded-3xl p-10 sm:p-12 md:p-16 relative overflow-hidden">
            {/* Decorative elements */}
            ...
            <div className="relative z-10">
              <h3 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#C8D5B9] mb-6 leading-tight">
                INTERESTED IN WORKING WITH US ON YOUR NEXT PROJECT?
              </h3>
              <p className="text-lg sm:text-xl text-[#C8D5B9]/80 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  ...
                  className="group relative overflow-hidden px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 bg-[#C8D5B9] text-[#142929] hover:bg-[#D4E7C5] hover:scale-105 hover:shadow-xl text-center"
                >
                  <span className="relative z-10">Send Email</span>
                </Link>
                <Link
                  href="/book-call"
                  className="group relative overflow-hidden px-8 py-4 text-lg font-semibold rounded-full transition-all duration-300 border-2 border-[#C8D5B9] text-[#C8D5B9] hover:bg-[#C8D5B9] hover:text-[#142929] hover:scale-105 hover:shadow-xl text-center"
                >
